...
## Installation
Download the entire respository from GitHub. Unzip the repository to your desired storage location. Check the progress bar below to see how installation is going.

|-------------------------------------------------------------------->|100% Complete

Congratulations! FOIAs has been installed on your system.
...
2. Click New Applicaiton to create a new Application.
   ...
   2.8. Individual letters generated by an application are saved in the database without an attached scan. It is recommended that you print, sign, scan, and attach each letter to its corresponding entry in the database.
